...
ghcr.io/wkarts/argws-git-monitor:latest

## Pull da imagem

Se o package estiver publico:

docker pull ghcr.io/wkarts/argws-git-monitor:latest
...
org.opencontainers.image.source=https://github.com/wkarts/argws-financial-platform
